    ...
    <div class="everything">
        ...
        <td class="menu">
            ...
            if (isset($_SESSION['logged_in'])) { ?><a class='menuSpecial' href="index.php?logout=1">       <b><?php echo $lng->getTrn('global/secLinks/logout');?></b></a>&nbsp;<?php }
            		...
            		echo "<a class='menuSpecial' href='index.php?section=login'><b>" .$lng->getTrn('global/secLinks/login'). "</b></a>&nbsp;&nbsp;";
            		
            		if ($settings['allow_automatic_registration'])
            			echo "<a class='menuSpecial' href='index.php?section=register'><b>" .$lng->getTrn('global/secLinks/register'). "</b></a>&nbsp;";
            }
            ?>
            <?php
        ...
        switch ($_GET['section']) 
        {
            ...
            case 'register':	 sec_register();	break;
            default:             sec_main();
        }
        ?>
