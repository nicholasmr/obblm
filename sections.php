                    ...
                    <div class='boxBody'>
                        <table class="boxTable">
                            <tr>
                                ...
                                <?php if ($tour->isRSWithPoints()) {echo "<td><b>PTS</b></td>\n";}?>
                                <td><b>Cas</b></td>
                                <td><b>W</b></td>
                                <td><b>L</b></td>
                                <td><b>D</b></td>
        ...
        if ($settings['entries_latest'] != 0) {
            ...
            <div class="boxWide">
                ...
                <div class='boxBody'>
                    <table class="boxTable">
                        <tr>
                            <td style="text-align: right;" width="50%"><b>Home</b></td><td> </td>
                            <td style="text-align: left;" width="50%"><b>Guest</b></td><td> </td>
                        </tr>
                        <?php
...
function sec_gallery() {
    ...
    title($lng->getTrn('menu/gallery'));

    if (isset($_POST['type'])) {
        echo "<center><a href='index.php?section=gallery'>".$lng->getTrn('common/back')."</a></center>\n";
        switch ($_POST['type'])
        {
            case 'team':
                echo "<b>".$lng->getTrn('gallery/playersof')." $t->name</b><br><hr><br>\n";
            ...
            case 'stad':
                echo "<b>".$lng->getTrn('gallery/stads')."</b><br><hr><br>\n";
            ...
            case 'coach':
                echo "<b>".$lng->getTrn('gallery/coaches')."</b><br><hr><br>\n";
    ...
    <li><?php echo inlineform(array('type' => 'stad'),  'stadForm',     $lng->getTrn('gallery/stads'));?></li>
    <li><?php echo inlineform(array('type' => 'coach'), 'coachesForm',  $lng->getTrn('gallery/coaches'));?></li>
    </ul>
    <?php
}
