...
"inflicted_foul_kos" => array("short" => "ko_fi","type" => "MEDIUMINT SIGNED NOT NULL DEFAULT 0", "group" => "Fouling Stats", "desc" => "fl_Number of times this player knocked out another through fouling"),
