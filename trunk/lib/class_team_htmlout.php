        ...
        <li><span class="dir">Roster</span>
            <ul>
                ...
                <?php if ($cyanide) { ?><li><span class="dir">Cyanide-DB</span>
                    <ul>
                        <li><a style="color: blue;" href="<?php echo $cyanide."=0";?>">Blue</a></li>
                        <li><a style="color: cyan;" href="<?php echo $cyanide."=1";?>">Cyan</a></li>
                        <li><a style="color: green;" href="<?php echo $cyanide."=2";?>">Green</a></li>
                        <li><a style="color: yellow;" href="<?php echo $cyanide."=3";?>">Yellow</a></li>
                        <li><a style="color: red;" href="<?php echo $cyanide."=4";?>">Red</a></li>
                        <li><a style="color: magenta;" href="<?php echo $cyanide."=5";?>">Magenta</a></li>
                        <li><a style="color: purple;" href="<?php echo $cyanide."=6";?>">Purple</a></li>
                        <li><a style="color: grey;" href="<?php echo $cyanide."=7";?>">Grey</a></li>
                    </ul>
                </li>
                <?php } ?>
            </ul>
